...
class DetectionMixin:
    ...
    def load_biome_data(self):
        url = "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/assets/biomes_data.json"
        eventUrl = "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/assets/active_events.json"
        ...
        default_biome_data = {
            ...
            "EGGLAND": {
                "color": "0xd4fc8d",
                "thumbnail_url": "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/images/EGGLAND.png"
            },  
            "WINDY": {
                "color": "0x9ae5ff",
            ...
            "CYBERSPACE": {
                "color": "0x0A1A3D",
                "thumbnail_url": "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/images/CYBERSPACE.png"
            }
        }
    ...
    def open_customize_biome_embed(self):
        event_url = "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/main/active_events.json"
        try:
    ...
    def start_detection(self):
        ...
        self.save_config()
        self.set_title_threadsafe(f"""Macteab Macro {current_ver} (Running)""")
        self.send_webhook_status("Macro started!", color=0x64ff5e)

        # Warmup OCR on macOS in the background to prevent freezes on first use
        if platform.system() == 'Darwin':
            threading.Thread(target=self.warmup_ocr_for_macos, name="OCR Warmup", daemon=True).start()
    ...
    def stop_detection(self):
        ...
        self.stop_sent = True
        self.set_title_threadsafe(f"Macteab Macro {current_ver} (Stopped)")
    ...
    def load_auras_json(self):
        url = "https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/assets/auras.json"
        try:
            r = requests.get(url, timeout=1)
            r.raise_for_status()
    ...
    def _merchant_teleporter_impl(self):
        ...
        try:
            ...
            time.sleep(0.1)
            pyautogui.moveTo(current_x, current_y + 75, duration=0.2)
            time.sleep(0.05)
            ...
            if _cancelled(): return
            pyautogui.click(use_button[0], use_button[1], clicks=3)
