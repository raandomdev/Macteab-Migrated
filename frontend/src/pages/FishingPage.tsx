...
export default function FishingPage() {
    ...
    const fishingAligncamEnabeled = config.fishing_aligncam_before_fishing || false;
    ...
    return (
        <>
            ...
            <div className="card">
                ...
                <ToggleSwitch
                    label="Align camera before fishing"
                    description="Align the camera before each fishing attempt."
                    checked={fishingAligncamEnabeled}
                    onChange={(val) => updateConfig("fishing_aligncam_before_fishing", val)}
                />
