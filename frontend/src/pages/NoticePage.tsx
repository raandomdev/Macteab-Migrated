...
export default function NoticePage() {
    ...
    useEffect(() => {
        fetch("https://raw.githubusercontent.com/raandomdev/Noteab-Macro/refs/heads/main/assets/noticetabcontents.txt")
            .then(res => res.text())
            .then(text => {
                setContent(text);
                setLoading(false);
    ...
    return (
        <>
            <div className="page-header">
                <h2>Notice</h2>
                <p>Latest updates and patch notes. This macOS porting is expect to be with bugs, pleace report any bugs to @spacedev0572 and report your problem. note that not all features its expected to work, since there are a lot of limitations to work with. Please also note that this macOS porting will be released at its own time. This means that every Coteab windows update will not be released at the same time. Thanks for your understanding!</p>
            </div>
