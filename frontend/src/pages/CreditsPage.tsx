        ...
        <>
            ...
            <div className="card">
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px", marginTop: "16px" }}>
                    ...
                    <a href="https://discord.gg/aurium-1282072537999872051" target="_blank" rel="noreferrer" style={{ color: "var(--accent)", fontSize: "13px" }}>
                        Discord: Radiance Development Server! (join meh and support meh by boosting!)
                    </a>
                </div>
            </div>
