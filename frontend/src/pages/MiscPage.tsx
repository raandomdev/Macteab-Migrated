        ...
        <>
            ...
            <div style={{
                ...
                {ocrStatus && !ocrStatus.installed && (
                    <span style={{ color: "var(--text-muted)", fontSize: "11px" }}>
                        — RapidOCR failsafe will not work (if RapidOCR haven't installed, ask macro helper to assist you about this!)
                    </span>
                )}
            </div>
            ...
            {/* <div className="card">
                <div className="card-header">
                    <div className="card-icon">⚡</div>
                    <div>
                        <h3>Limbo Item Usage &amp; Eden Detection (DOES NOT WORK DUE TO PATHING ISSUES)</h3>
