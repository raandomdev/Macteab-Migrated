...
```bash
pyinstaller --name="MacteabMacro" --noconsole --onefile --noupx --icon="lib/official_release.ico" --add-data "lib:lib"  --collect-all webview --collect-all discord main.py
```
